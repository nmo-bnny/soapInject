...
# https://github.com/nmo-bnny/soapInject/
# This tool is meant to send payloads to target functions via the SOAP protocol always test on your own systems!
...
# Copy paste header values or type in seperate by commas (If you don't know how to do this check my walkthrough on my github)
